...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Atur Pengguna'])
                            ...
                            <tbody class="data-body">
                                ...
                                <tr>
                                    ...
                                    <td class="col-b" width="25%">
                                        <p class="text-sm font-weight-bold mb-0">{{($user->user_role_id == 99) ? "Admin" : (($user->user_role_id == 1) ? "Staff Proyek" : (($user->user_role_id == 2) ? "Manajer Proyek" : "Kepala SBU"))}}</p>
                                    </td>
                                    <td class="align-middle text-center text-sm col-c" width="25%">
                                        <p class="text-sm font-weight-bold mb-0">{{$user->email}}</p>
                                    </td>
                                    <td class="align-middle text-center text-sm" width="25%">
                                        <p class="text-sm font-weight-bold mb-0">{{date('d/m/Y H:i:s',strtotime($user->created_at))}}</p>
                                    </td>
                                    <td class="align-middle text-end" width="25%">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            <p data-id="{{$user->id}}" class="text-sm btn mx-2 edit text-primary font-weight-bold mb-0">Edit</p>
                                            <p data-id="{{$user->id}}" class="text-sm btn mx-2 del text-danger font-weight-bold mb-0">Delete</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                ...
                <tr>
                    <td width="25%">
                        <div class="d-flex px-3 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center col-a">
                                <input type="text" placeholder="Username" name="name_add" class="form-control input-a">
                            </div>
                        </div>
                    </td>
                    <td class="col-b" width="25%">
                    ...
                    <td class="align-middle text-center text-sm input-b">
                        <input type="text" placeholder="Email" name="email_add" class="form-control input-c">
                    </td>
                    <td class="align-middle text-center text-sm">
                        <input type="password" placeholder="Password" name="email_add" class="form-control input-d">
                    </td>
