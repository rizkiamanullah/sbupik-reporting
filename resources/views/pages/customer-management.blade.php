...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Atur Customer'])
                                    ...
                                    <td width="25%">
                                        <div class="d-flex px-3 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center col-a">
                                                <h6 class="mb-0 text-sm">{{$cust->nama}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center text-sm" width="25%">
                                        <p class="text-sm font-weight-bold mb-0">{{date('d/m/Y H:i:s',strtotime($cust->created_at))}}</p>
                                    </td>
                                    <td class="align-middle text-end" width="25%">
                                        <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                            <p data-id="{{$cust->id}}" class="text-sm btn mx-2 edit text-primary font-weight-bold mb-0">Edit</p>
                                            <p data-id="{{$cust->id}}" class="text-sm btn mx-2 del text-danger font-weight-bold mb-0">Delete</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
